...
export default function PhanTichDiDongPSCTheoTram_thang() {

  // Tính tháng trước mặc định
const currentDate = new Date();
const prevMonthDate = new Date(currentDate.getFullYear(), currentDate.getMonth() - 1, 1); // Lùi 1 tháng
...
const defaultMonth = `${prevMonthDate.getFullYear()}${String(prevMonthDate.getMonth() + 1).padStart(2, '0')}`;
  ...
  const [selectedDate, setSelectedDate] = useState(prevMonthDate); // Set thẳng vào DatePicker
...
//sx={{ p: 2, pb: 8 }}
  return (
      ...
      DOANH THU SỐ LƯỢNG TB PSC TRẢ TRƯƠC THEO ĐƠN VỊ THÁNG
      </Typography>
