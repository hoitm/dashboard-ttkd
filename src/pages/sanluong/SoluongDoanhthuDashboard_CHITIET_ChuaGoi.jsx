...
import { getChiTietChuaGoi } from '../../services/sanluongApi';
//import jsPDF from 'jspdf';
//import autoTable from 'jspdf-autotable';

export default function SoluongDoanhthuDashboard_CHITIET_ChuaGoi() {
  ...
  const fetchData = async () => {
    try {
      const result = await getChiTietChuaGoi(hrm_code, fromDate, toDate);
      setData(result || []);
    } catch (err) {
            ...
            <Card key={idx} className="mb-2 border border-gray-300 rounded-lg shadow-sm">
              <CardContent className="p-3">
                ...
                <Typography className="text-xs text-gray-600">
                  <strong>Ngày kh:</strong> {row.NgayKichHoat}
                </Typography>
